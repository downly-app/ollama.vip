  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[420px] bg-white/10 backdrop-blur-xl border border-white/20 text-white shadow-2xl rounded-2xl">
        <DialogHeader>
          <DialogTitle className={`text-xl font-semibold bg-gradient-to-r ${currentTheme.colors.secondary} bg-clip-text text-transparent flex items-center justify-between`}>
            {t('profile.title')}
            {!isEditing && (
              <Button
                variant="ghost"
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className={`relative w-20 h-20 rounded-full bg-gradient-to-br ${currentTheme.colors.primary} flex items-center justify-center shadow-lg`}>
              {profile.avatar ? (
